...
2. ফাইলটিতে ডাবল-ক্লিক করে ইনস্টল করুন। (যদি ম্যাক ওএস সিকিউরিটি ওয়ার্নিং দেয়, তবে ফাইলের ওপর রাইট ক্লিক করে Open করুন)।
3. **Launchpad** বা **Applications** ফোল্ডার থেকে **UniJoy** অ্যাপটি ওপেন করুন।
4. অ্যাপের ভেতরের **"ইনস্টল করুন" (Install)** বাটনে ক্লিক করুন!
5. ওয়ান-ক্লিক ইনস্টলেশনের পর কীবোর্ডটি রেজিস্টার হতে ৩-৫ সেকেন্ড সময় নিবে এবং কোনো রিস্টার্ট ছাড়াই প্রস্তুত হয়ে যাবে।

> ⚙️ **ম্যানুয়ালি কীবোর্ড যুক্ত করার নিয়ম (যদি স্বয়ংক্রিয়ভাবে লিস্টে না আসে):**
> 1. আপনার ম্যাকের **System Settings** ➔ **Keyboard** অপশনে যান।
> 2. **Input Sources**-এর পাশে থাকা **Edit...** বাটনে ক্লিক করুন।
> 3. নিচে বাম কোণায় থাকা **`+` (Add)** আইকনটিতে ক্লিক করুন।
> 4. বাম পাশের কলামের ভাষা তালিকা থেকে স্ক্রল করে নিচে নেমে **Others (অন্যান্য)** সিলেক্ট করুন।
> 5. ডান পাশের লেআউট তালিকা থেকে **"ইউনিজয়" (UniJoy)** সিলেক্ট করে **Add** বাটনে ক্লিক করুন।
